...
'''
    ...
    1 2 0 1 0 0 1  e che e' riportato nel file albero_di_gioco.pdf
    ...
    Definire una funzione es1(s) ricorsiva (o che fa uso di funzioni o
    ...
    delle sequenze finali che e' possibile ottenere.
      Ad esempio con s='1 2 0 1 0 0 1' la funzione es1 deve restituire  l'insieme
      {'2 0 1', '2 1 0', '1 2 0'}
